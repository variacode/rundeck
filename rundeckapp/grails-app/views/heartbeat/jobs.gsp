...
<head>
    ...
    <script type="text/javascript">
        ...
        function BulkEditor(){
            ...
            self.ADMIN_EXECUTION_NODE = 'admin';
            self.DELETE= 'delete';
            self.action=ko.observable(null);
            self.enabled=ko.observable(true);
            self.goToAdmin=function(){
                self.action(self.ADMIN_EXECUTION_NODE);
            };
...
<div>
    <div class="" style="margin-top: 10px; display: block;" id="bulk_edit_panel" data-bind="visible: enabled" >
        <div class="bulk_edit_controls panel"  >
