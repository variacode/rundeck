...
class AA_TimerInterceptor {
	...
	static requests=[:]
    public static final String _TIMER = 'AA_TimerInterceptor._TIMER'
    public static final String _METRICS_TIMER = 'AA_TimerInterceptor._METRICS_TIMER'
    public static final String _TIMER_ITEM = 'AA_TimerInterceptor._timer_item'
    public static final String _REPORTS = 'AA_TimerInterceptor._reports'
    public static final String _REQ_URI = 'AA_TimerInterceptor._req_uri'
