...
class AuthorizationInterceptor {
    ...
    public AuthorizationInterceptor() {
        matchAll().excludes(controller:'user', action:'logout')
                ...
                .excludes(controller:'user', action:'error')
                .excludes(controller:'user', action:'loggedout')
    }
...
//            render(view: '/common/error.gsp')
            println '<------------------------inside errorpage---------------------->'
            def o = groovyPageRenderer.render view: '/common/error.gsp'
            render o
            return false
        }
